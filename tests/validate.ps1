...
Assert-Contains $install 'Install-AutoHotkeyDirect' "Installer should fall back to the official AutoHotkey GitHub installer"
Assert-Contains $install 'AutoHotkey/AutoHotkey/releases/latest' "Installer should discover the latest official AutoHotkey release"
Assert-Contains $install '/silent' "Installer should run the direct AutoHotkey setup silently"
Assert-Contains $install '/user' "Installer should install AutoHotkey for the current user when using direct setup"
